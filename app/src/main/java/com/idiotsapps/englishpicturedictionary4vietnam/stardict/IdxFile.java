...
public class IdxFile {
    ...
    public IdxFile(FileInputStream in, FileOutputStream out, long wordCound, long fileSize) {
        strFileName = null;
        isEnableStream = true;
        longWordCount = wordCound;
    ...
    public void load() {
        if ((boolIsLoaded || (!(new java.io.File(strFileName)).exists()))) {
            Log.d("testing", "file" + strFileName + " not exist");
            return;
        }
        try {
            DataInputStream dt;
    ...
    public boolean write(String fileName) {
        try {
            ...
            if(isEnableStream){
                ...
                dt = new DataOutputStream(new FileOutputStream(fileName));
            }
