...
public class IfoFile {
     ...
     */
    public IfoFile(FileInputStream fileInputStream, FileOutputStream fileOutputStream) {
        strFileName = null;
        isEnableStream = true;
    ...
    public void load() {
        ...
        try {
            ...
            DataInputStream dt;
            if (isEnableStream) {
                dt = new DataInputStream(new BufferedInputStream(this.inputStream));
            }else{
            ...
            Log.e("Loading file '" + strFileName + "'", ex.toString());
        }
    }
