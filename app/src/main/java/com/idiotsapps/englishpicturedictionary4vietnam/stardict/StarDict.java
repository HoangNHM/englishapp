...
public class StarDict {
    ...
    public StarDict(String ifo, String idx, String dict) {
        ifoFile = new IfoFile(ifo);
        idxFile = new IdxFile(idx, ifoFile.getLongWordCount(), ifoFile.getLongIdxFileSize());
        dictFile = new DictFile(dict);
